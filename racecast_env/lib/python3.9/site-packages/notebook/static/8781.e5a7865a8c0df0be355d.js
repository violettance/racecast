...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72493);
...
async function main() {
  const mimeExtensionsMods = [
    ...
    __webpack_require__(48653),
    __webpack_require__(1038),
    __webpack_require__(42861),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(64435),
  __webpack_require__(11015),
  __webpack_require__(44310),
  __webpack_require__(66828),
  __webpack_require__(86032),
  __webpack_require__(73371),
  __webpack_require__(87957),
  
      (__webpack_require__(28890)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(4731)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      (__webpack_require__(71170)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(46848)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(50729),
  
      (__webpack_require__(62067)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(46081)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(60058)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(37)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(86909)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(22163),
  __webpack_require__(16758),
  __webpack_require__(22094),
  
      (__webpack_require__(28173)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(19816),
  __webpack_require__(40058),
  __webpack_require__(56226),
  
      (__webpack_require__(20007)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(25058),
  __webpack_require__(45955),
  __webpack_require__(77077),
  __webpack_require__(36296),
  __webpack_require__(43482),
  __webpack_require__(92566),
  __webpack_require__(84013),
  __webpack_require__(75896),
  __webpack_require__(38307),
  __webpack_require__(72650),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(16598),
  
      (__webpack_require__(69583)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(32707),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(99418),
  __webpack_require__(61743),
  
      (__webpack_require__(68032)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(80219),
  __webpack_require__(30065),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(58005)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(55656)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(3339).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(95279).IServiceManager);
...
//# sourceMappingURL=8781.e5a7865a8c0df0be355d.js.map?v=e5a7865a8c0df0be355d